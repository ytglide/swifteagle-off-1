...
export function WorldMap({
  ...
  useEffect(() => {
    // Initialize DottedMap only on client side
    try {
  ...
  // Don't render until svgMap is ready
  if (!svgMap) {
    return (
      <div className="w-full aspect-[2/1] bg-white rounded-lg relative font-sans flex items-center justify-center">
